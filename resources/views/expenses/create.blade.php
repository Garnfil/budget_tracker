    ...
    <div class="content-wrapper">
        <div class="content-header row">
            <div class="content-header-left col-md-6 col-12 mb-2">
                <h3 class="content-header-title mb-0">Add Expense</h3>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    ...
                                    <select name="expense_category_id" class="form-control" id="expense-category-field">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="Amount"
                                            aria-describedby="currency-symbol" name="amount">
                                    </div>
                                    <div class="text-danger danger">
                                        @error('amount')
                                            {{ $message }}
                            ...
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    ...
                                    <textarea name="description" id="description-field" cols="30" rows="3" class="form-control"></textarea>
                                    <div class="text-danger danger">
                                        @error('description')
                                            {{ $message }}
                                        @enderror
            ...
            $.ajax({
                ...
                success: function (data) {
                    data.expense_categories.forEach(expense_category => {
                        var newOption = new Option(expense_category.name, expense_category.id, true, true);
