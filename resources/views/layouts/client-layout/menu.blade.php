<ul class="nav navbar-fixed navbar-nav" id="main-menu-navigation" data-menu="menu-navigation">
    ...
    <li class="dropdown nav-item" data-menu="dropdown"><a class="dropdown-toggle nav-link" href="index.html" data-toggle="dropdown">
        ...
        <ul class="dropdown-menu">
            <li data-menu=""><a class="dropdown-item" href="{{ route('income-categories.index') }}" data-i18n="Income Categories" data-toggle="dropdown">Income Categories</a>
            </li>
            <li data-menu=""><a class="dropdown-item" href="{{ route('expense-categories.index') }}" data-i18n="Expense Categories" data-toggle="dropdown">Expense Categories</a>
            </li>
        </ul>
    </li>
    <li class="dropdown nav-item" data-menu="dropdown"><a class="dropdown-toggle nav-link" href="index.html" data-toggle="dropdown">
        ...
        <ul class="dropdown-menu">
            <li data-menu=""><a class="dropdown-item" href="{{ route('incomes.index') }}" data-i18n="Incomes" data-toggle="dropdown">Incomes</a>
            </li>
            <li data-menu=""><a class="dropdown-item" href="{{ route('expenses.index') }}" data-i18n="Expenses" data-toggle="dropdown">Expenses</a>
            </li>
        </ul>
    </li>
</ul>