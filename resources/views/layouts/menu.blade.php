<ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
    ...
    <li class=" nav-item"><a href="#"><i class="feather icon-box"></i><span class="menu-title"
        ...
        <ul class="menu-content">
            <li><a class="menu-item" href="{{ route('clients.index') }}" data-i18n="Income Categories">Income Categories</a>
            </li>
            <li><a class="menu-item" href="#" data-i18n="Expense Categories">Expense Categories</a>
            </li>
        </ul>
    </li>
