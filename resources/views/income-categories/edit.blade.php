    ...
    <div class="content-wrapper">
        <div class="content-header row">
            <div class="content-header-left col-md-6 col-12 mb-2">
                <h3 class="content-header-title mb-0">Edit Income Category</h3>
                <div class="row breadcrumbs-top">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Edit Income Category
                            </li>
                        </ol>
                    </div>
                </div>
                        ...
                        <div class="row">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="budget_id" id="budget_id" class="select2">
                                        ...
                                        @foreach ($budgets as $budget)
                                            <option value="{{ $budget->id }}" {{ $budget->id == $income_category->budget_id ? 'selected' : null }}>
                            ...
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="name" id="name-field" value="{{ $income_category->name }}">
                            ...
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" name="goal_amount" id="goal-amount-field" value="{{ $income_category->goal_amount }}">
                                    </div>
                            ...
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    ...
                                    <textarea name="note" id="note-field" cols="30" rows="3" class="form-control">{{ $income_category->note }}</textarea>
